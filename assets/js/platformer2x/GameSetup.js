...
import Mouth from './Goomba.js';
import Mouth2 from './FlyingGoomba.js';
...
const GameSetup = {
    ...
    */
    ...
    assets: {
      ...
      backgrounds: {
        ...
        avenida: { src: "/images/platformer/backgrounds/cafe.png" },
      ...
      players: {
        ...
        cookie: {
          src: "/images/platformer/sprites/cookie.png", 
          width: 32,
          height: 32,
          scaleSize: 60,
          speedRatio: 1,
          ...
          wa: {row: 1, frames: 3},
          wd: {row: 0, frames: 3},
          idle: { row: 2, frames: 4, idleFrame: {column: 0, frames: 0} },
          a: { row: 0, frames: 3, idleFrame: { column: 0, frames: 0 } }, // Right Movement
          s: {row: 0, frames: 3}, // Stop the movement 
          d: { row: 1, frames: 3, idleFrame: { column: 0, frames: 0 } }, // Left Movement 
          runningLeft: { row: 0, frames: 3, idleFrame: {column: 1, frames: 0} },
          runningRight: { row: 1, frames: 3, idleFrame: {column: 1, frames: 0} },
        }
      },
      enemies: {
        mouth: {
          src: "/images/platformer/sprites/mouth.png",
          width: 50,
          height: 50,
          scaleSize: 100,
          speedRatio: 0.7,
    ...
    */
    ...
    initLevels: function(path) {  // ensure valid {{site.baseurl}} for path
        ...
        { name: 'mouth', id: 'mouth', class: Mouth, data: this.assets.enemies.mouth, xPercentage: 0.3, yPercentage: 1, minPosition: 0.05},
        { name: 'mouth', id: 'mouth', class: Mouth, data: this.assets.enemies.mouth, xPercentage:  0.5, yPercentage: 1, minPosition: 0.3 },
        ...
        { name: 'mouth', id: 'mouth', class: Mouth, data: this.assets.enemies.mouth, xPercentage:  0.75, yPercentage: 1, minPosition: 0.5 }, //this special name is used for random event 2 to make sure that only one of the Goombas ends the random event
        ...
        { name: 'mouth', id: 'mouth', class: Mouth, data: this.assets.enemies.mouth, xPercentage: 0.3, minPosition: 0.05},
        { name: 'mouth', id: 'mouth', class: Mouth, data: this.assets.enemies.mouth, xPercentage:  0.5, minPosition: 0.3 },
        { name: 'mushroom', id: 'mushroom', class: Mushroom, data: this.assets.enemies.mushroom, xPercentage: 0.09},
        { name: 'mouth', id: 'mouth', class: Mouth, data: this.assets.enemies.mouth, xPercentage:  0.75, minPosition: 0.5 }, //this special name is used for random event 2 to make sure that only one of the Goombas ends the random event
        { name: 'mouth2', id: 'mouth2', class: Mouth2, data: this.assets.enemies.mouth2, xPercentage:  0.5, minPosition:  0.05},
        { name: 'mouth2', id: 'mouth2', class: Mouth2, data: this.assets.enemies.mouth2, xPercentage:  0.9, minPosition: 0.5},
        { name: 'cookie', id: 'player', class: Player, data: this.assets.players.cookie },
        { name: 'tube', id: 'tube', class: Tube, data: this.assets.obstacles.tube },
