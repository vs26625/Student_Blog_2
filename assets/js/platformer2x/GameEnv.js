...
export class GameEnv {
     ...
     * @property {boolean} mouthInvincible - invincibility for the goomba when mario touch
     * @property {boolean} mouthBounce - mario touch goomba --> bounce
     * @property {boolean} mouthBounce1 - bounce on mushroom
    ...
    static mouthInvincible = false;
    static mouthBounce = false;
    static mouthBounce1 = false;
